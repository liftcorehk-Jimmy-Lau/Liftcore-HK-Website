...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.product-card, .service-card, .stat-item');
...
// Enhanced modern elevator animation
...
// Add interactive floor indicators
const floorIndicators = document.querySelectorAll('.floor-indicator');
floorIndicators.forEach((indicator, index) => {
    indicator.addEventListener('click', function() {
        // Remove active class from all indicators
        floorIndicators.forEach(ind => ind.classList.remove('active'));
        // Add active class to clicked indicator
        this.classList.add('active');
        
        // Show notification with floor number
        const floorNumber = this.textContent;
        showNotification(`Elevator moving to floor ${floorNumber}`, 'info');
    });
});
...
function createParticle() {
    ...
    const animationEffects = document.querySelector('.animation-effects');
    if (animationEffects) {
